...
import GifAluraGeek from "/assets/gifs/alurageek.gif";
...
export const cards = [
    ...
    {   id: 6,
        titulo: "AluraGeek",
        texto: "Esta aplicação é um desafio da Alura em parceira com a Oracle. Para mostrar o avanço das minhas habilidades em desenvolver uma API REST e trabalhar com os váriados métodos, que são GET, POST e DELETE. Para utilizá-lo você terá de clonar o repositório em sua máquina. Basta seguir os passo que estão na descrição do README do próprio projeto.",
        tectnologias: "HTML, CSS, JS e API.",
        endereco: GifAluraGeek,
        urlProjeto: "",
        urlRepositorio: "https://github.com/Moiseis-Cruz/AluraGeek",
    },
];
